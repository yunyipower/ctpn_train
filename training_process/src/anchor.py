...
class AnchorText:
    ...
    def generate_basic_anchors(self, sizes, base_size=16):
        ...
        if cfg.TRAIN.DEBUG:
            print "AnchorText: base_anchor: {}".format(base_anchor)
    ...
    def scale_anchor(self, anchor, h, w):
        ...
        if cfg.TRAIN.DEBUG:
            print "AnchorText: scale_anchor, param: anchor {}, h {} w {}".format(anchor, h, w)
    ...
    def apply_deltas_to_anchors(self, boxes_delta, anchors):
        ...
        return np.hstack((anchors[:, [0]],
                          global_coords[:, [0]],
                          anchors[:, [2]],
                          global_coords[:, [0]]+global_coords[:, [1]]
                        )).astype(np.float32)
    ...
    def locate_anchors(self, feat_map_size, feat_stride):
        ...
        if Debug:
            print "basic_anchors shape: {}".format(basic_anchors_.shape)
