...
class TextProposalGraphBuilder:
    ...
    def build_graph(self, text_proposals, scores, im_size):
        print "[build_graph] text_proposals shape: {}, scores: shape: {}, im_size: {}".format(text_proposals.shape,\
            scores.shape, im_size)
        ...
        #generate the index list based on same x-aixs added by youlie
        print "[build_graph] text_proposals: {}".format(text_proposals)
